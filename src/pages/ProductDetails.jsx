    ...
    <section className="text-gray-600 body-font overflow-hidden bg-gray-200">
            <div className="container px-5 py-24 mx-auto">
                <div className="lg:w-4/5 mx-auto flex flex-wrap">
                    <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto h-64 object-contain max-h-[500px] object-center rounded" src={product.image} />
                    ...
                    <div className="flex justify-center align-bottom">
                            <Link to="/" className="text-xl  font-bold hover:text-blue-500">Home</Link>
                   </div>
                </div>
            </div>
        </section>
